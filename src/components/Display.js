			...
			<div className="efficiency">
				...
				<div className="row has-vertical-align-center">
					<div className="col text-center">
						<a href={'?month='+(props.data.currentMonth-1)}><b>&lt;&nbsp;{props.data.user.prevmonth}</b></a>
					</div>
					...
					<div className="col text-center">
						{props.data.user.nextmonth && <a href={'?month='+(props.data.currentMonth+1)}><b>{props.data.user.nextmonth}&nbsp;&gt;</b></a>}
					</div>
				</div>
